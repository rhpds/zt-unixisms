...
perform administrative tasks. Privileges can be assigned to groups, users, and other ways.
Traditionally, users in the _wheel_ group have elevated access via the `sudo` command. 
