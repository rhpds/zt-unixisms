...
You will see that `grep` fills in, and you can hit
enter to execute the command. If the tab completion for the `man` command
still can't uniquely identify `grep`, add one more letter and hit `tab` again.
[source,sh]
----
man -f gr
----
